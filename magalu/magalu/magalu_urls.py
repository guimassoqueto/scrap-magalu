MAGALU_URLS = {
    ...
    "cama_mesa_banho": [f"https://www.magazineluiza.com.br/cama-mesa-e-banho/l/cm/seller---magazineluiza/?page={i}" for i in range(1, 11)],
    "eletrodomesticos": [f"https://www.magazineluiza.com.br/eletrodomesticos/l/ed/seller---magazineluiza/?page={i}" for i in range(1, 11)],
